...
| 17 - Projects List | Quản trị công ty, mục tiêu và dự án | `/projects` | Real UI structural pass | 88.4786% |
...
| 25 - Agent Template Gallery | Quản lý đội ngũ AI agent, hồ sơ, kỹ năng, hiệu suất | `/agents/templates` | Real UI structural pass / source PNG section recalibrated | 89.1275% |
...
| 34 - Run Console | Quản lý ticket, run console và artifact | `/runs/demo-run` | Real UI structural pass | 90.9920% |
...
|---:|---|---|---:|
| 1 | 17 - Projects List | `/projects` | 88.4786% |
| 2 | 25 - Agent Template Gallery | `/agents/templates` | 89.1275% |
