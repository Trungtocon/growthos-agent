...
| 17 - Projects List | Quản trị công ty, mục tiêu và dự án | `/projects` | Real UI structural pass | 89.0152% |
...
|---:|---|---|---:|
| 1 | 17 - Projects List | `/projects` | 89.0152% |
| 2 | 25 - Agent Template Gallery | `/agents/templates` | 89.1279% |
| 3 | 26 - Agent Performance | `/agents/performance` | 89.2206% |
