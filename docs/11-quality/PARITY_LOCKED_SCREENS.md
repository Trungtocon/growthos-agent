...
| 17 | `/projects` | `ProjectsListScreen` / `AppShell` | 11.0437% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_17` layout assets rendered |
...
| 17 | `/projects` | Real UI | `ProjectsListScreen + AppShell` | Pass | Pass 8/8 | 11.0437% | Real UI Structural PASS / Visual Polish Deferred |
