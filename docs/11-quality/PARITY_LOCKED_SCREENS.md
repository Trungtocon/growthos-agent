...
| 17 | `/projects` | `ProjectsListScreen` / `AppShell` | 11.1053% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred | No static `parity_17` layout assets rendered |
...
| 25 | `/agents/templates` | `AgentTemplatesScreen` / `AppShell` | 10.8725% | Real UI Structural PASS / Source PNG Section Recalibrated / Visual Polish Deferred | No static `parity_25` layout assets rendered |
...
| 17 | `/projects` | Real UI | `ProjectsListScreen + AppShell` | Pass | Pass 10/10 | 11.1053% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred |
...
| 25 | `/agents/templates` | Real UI | `AgentTemplatesScreen + AppShell` | Pass | Pass 8/8 | 10.8725% | Real UI Structural PASS / Source PNG Section Recalibrated / Visual Polish Deferred |
