...
| 17 | `/projects` | `ProjectsListScreen` / `AppShell` | 12.3208% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred | No static `parity_17` layout assets rendered |
...
| 26 | `/agents/performance` | `AgentPerformanceScreen` / `AppShell` | 11.0162% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_26` layout assets rendered |
...
| 17 | `/projects` | Real UI | `ProjectsListScreen + AppShell` | Pass | Pass 10/10 | 12.3208% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred |
...
| 26 | `/agents/performance` | Real UI | `AgentPerformanceScreen + AppShell` | Pass | Pass 12/12 | 11.0162% | Real UI Structural PASS / Visual Polish Deferred |
...
- Screen 26 was recalibrated in Sprint 5O against `public/stitch_ui/26_Agent_Performance.png`; its route-specific structural gate now passes 12/12 and pixel diff improved to 11.0162% after topbar search alignment polish.
