...
| 17 | `/projects` | `ProjectsListScreen` / `AppShell` | 10.7974% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred | No static `parity_17` layout assets rendered |
...
| 17 | `/projects` | Real UI | `ProjectsListScreen + AppShell` | Pass | Pass 10/10 | 10.7974% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred |
...
- Screen 17 was further polished to 10.7974% by simplifying the active project card progress row so cost metadata no longer competes with the progress value in the board card body.
