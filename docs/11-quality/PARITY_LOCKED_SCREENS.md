...
| 12 | `/company/overview` | `CompanyOverviewScreen` / `AppShell` | 7.7707% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_12` layout assets rendered |
| 13 | `/company/settings` | `CompanySettingsScreen` / `AppShell` | 5.9535% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_13` layout assets rendered |
...
| 17 | `/projects` | `ProjectsListScreen` / `AppShell` | 11.1671% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_17` layout assets rendered |
...
| 21 | `/org-chart` | `OrgChartRealPage` | 10.6991% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_21` layout assets rendered |
...
| 25 | `/agents/templates` | `AgentTemplatesScreen` / `AppShell` | 10.9707% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_25` layout assets rendered |
| 26 | `/agents/performance` | `AgentPerformanceScreen` / `AppShell` | 11.2214% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_26` layout assets rendered |
...
| 34 | `/runs/demo-run` | `RunConsoleRealPage` | 12.1734% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_34` layout assets rendered |
...
| 38 | `/approvals/demo-approval` | `ApprovalDetailScreen` / `AppShell` | 8.5569% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_38` layout assets rendered |
...
| 46 | `/integrations` | `IntegrationsHubScreen` / `AppShell` | 7.8805% | Real UI Structural PASS / Visual Polish Deferred | No static `parity_46` layout assets rendered |
...
| 12 | `/company/overview` | Real UI | `CompanyOverviewScreen + AppShell` | Pass | Pass 8/8 | 7.7707% | Real UI Structural PASS / Visual Polish Deferred |
| 13 | `/company/settings` | Real UI | `CompanySettingsScreen + AppShell` | Pass | Pass 7/7 | 5.9535% | Real UI Structural PASS / Visual Polish Deferred |
...
| 17 | `/projects` | Real UI | `ProjectsListScreen + AppShell` | Pass | Pass 8/8 | 11.1671% | Real UI Structural PASS / Visual Polish Deferred |
...
| 21 | `/org-chart` | Real UI | `OrgChartRealPage + AppShell` | Pass | Pass 10/10 | 10.6991% | Real UI Structural PASS / Visual Polish Deferred |
...
| 25 | `/agents/templates` | Real UI | `AgentTemplatesScreen + AppShell` | Pass | Pass 8/8 | 10.9707% | Real UI Structural PASS / Visual Polish Deferred |
| 26 | `/agents/performance` | Real UI | `AgentPerformanceScreen + AppShell` | Pass | Pass 12/12 | 11.2214% | Real UI Structural PASS / Visual Polish Deferred |
...
| 34 | `/runs/demo-run` | Real UI | `RunConsoleRealPage + AppShell` | Pass | Pass 16/16 | 12.1734% | Real UI Structural PASS / Visual Polish Deferred |
...
| 38 | `/approvals/demo-approval` | Real UI | `ApprovalDetailScreen + AppShell` | Pass | Pass 8/8 | 8.5569% | Real UI Structural PASS / Visual Polish Deferred |
...
| 46 | `/integrations` | Real UI | `IntegrationsHubScreen + AppShell` | Pass | Pass 8/8 | 7.8805% | Real UI Structural PASS / Visual Polish Deferred |
...
- Screen 21 active real component is `OrgChartRealPage + AppShell`; static guardrail Pass; structural gate Pass 10/10; pixel diff 10.6991%.
...
- Screen 34 active real component is `RunConsoleRealPage + AppShell`; static guardrail Pass; structural gate Pass 16/16; pixel diff 12.1734% after lowest 1:1 visual polish on Run Console status metrics.
...
- Screens 12 through 19 are company/goals/projects Real UI routes promoted in Sprint 5G.
- Do not revert Screens 12-19 to static slices to chase pixel diff.
...
- Screen 26 was recalibrated in Sprint 5O against `public/stitch_ui/26_Agent_Performance.png`; its route-specific structural gate now passes 12/12 and pixel diff improved to 11.2214%.
...
- Screens 31/33/35/36 use shared selector-driven ticket, run, artifact, and agent data with structural bbox gates.
