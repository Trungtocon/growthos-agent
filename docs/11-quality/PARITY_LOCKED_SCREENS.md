...
| 25 | `/agents/templates` | `AgentTemplatesScreen` / `AppShell` | 11.6725% | Real UI Structural PASS / Source PNG Section Recalibrated / Visual Polish Deferred | No static `parity_25` layout assets rendered |
...
| 25 | `/agents/templates` | Real UI | `AgentTemplatesScreen + AppShell` | Pass | Pass 8/8 | 11.6725% | Real UI Structural PASS / Source PNG Section Recalibrated / Visual Polish Deferred |
