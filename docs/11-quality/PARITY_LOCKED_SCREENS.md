...
| 17 | `/projects` | `ProjectsListScreen` / `AppShell` | 13.1152% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred | No static `parity_17` layout assets rendered |
...
| 17 | `/projects` | Real UI | `ProjectsListScreen + AppShell` | Pass | Pass 10/10 | 13.1152% | Real UI Structural PASS / Section Coverage Rebuilt / Visual Polish Deferred |
