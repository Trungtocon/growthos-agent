...
| 5AF-screen-25-qa-avatar | Screen 25 template card avatar tone polish | Partial | Pending | BBox 25 pass 8/8, Screen 25 pixel reference pass at 10.8721% | Improved `/agents/templates` from 10.8725% to 10.8721% by matching the Hermes QA card avatar tone closer to the source PNG; header copy/icons, expanded categories, accented descriptions, and accented difficulty labels were tested and reverted because they worsened diff |
...
| 5AB-screen-17-board-header | Screen 17 projects board header polish | Partial | Pending | BBox 17 pass 10/10, Screen 17 pixel reference pass at 11.3228% | Improved `/projects` from 11.3301% to 11.3228% by matching board column headers to the PNG's color-dot and neutral count-pill treatment; a completed-card rewrite was tested and reverted because it worsened diff |
| 5AC-screen-17-health-chart | Screen 17 projects health chart polish | Partial | Pending | BBox 17 pass 10/10, Screen 17 pixel reference pass at 11.1053% | Improved `/projects` from 11.3228% to 11.1053% by adding DOM dashed gridlines and recalibrating cost-bar height in Project Health Overview; legend percentage text was tested and reverted because it worsened diff |
| 5AD-screen-17-board-tone | Screen 17 projects board tone polish | Partial | Pending | BBox 17 pass 10/10, Screen 17 pixel reference pass at 11.0748% | Improved `/projects` from 11.1053% to 11.0748% by aligning HR Onboarding Flow with the PNG's blue planning-card treatment and neutralizing completed card borders; adding filter icons and project-specific goal copy were tested and reverted because they worsened diff |
| 5AE-screen-17-header-icons | Screen 17 projects header icon polish | Partial | Pending | BBox 17 pass 10/10, Screen 17 pixel reference pass at 11.0731% | Improved `/projects` from 11.0748% to 11.0731% by matching the source PNG's plus icon for create project and upload-tray icon for import project while preserving AppShell and board geometry |
