...
export function RuntimeCertificationPage() {
  ...
  return (
    <div data-route="/runtime-certification" data-runtime-certification-route>
      ...
      <EnvironmentReadinessCompactWidget surface="runtime-certification" />
      <ProductionConfigEvidenceCompactWidget surface="runtime-certification" />
      <GoLiveControlCompactWidget surface="runtime-certification" />
      <PageHeader
