  ...
  return (
    <div>
      <div data-parity-id="projects.header" className="flex min-h-[68px] items-start justify-between gap-4">
        ...
        <div className="flex gap-3 pt-[6px]"><Button variant="secondary"><Upload className="h-4 w-4" />Import Project</Button><Button variant="secondary"><Download className="h-4 w-4" />Export Report</Button><Button><Plus className="h-4 w-4" />Tạo dự án mới</Button></div>
      </div>
    ...
    <div>
      <div data-parity-id="agent-performance.header" className="flex h-[48px] items-start justify-between gap-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-[26px] font-bold leading-tight text-slate-950">Agent Performance</h1>
            <p className="mt-1 max-w-3xl text-sm text-slate-600">Do luong hieu suat, chat luong, chi phi va do tin cay cua doi ngu AI Agent</p>
          </div>
        </div>
        <div className="flex gap-3"><Button variant="secondary"><SlidersHorizontal className="h-4 w-4" />Compare Agents</Button><Button variant="secondary"><Download className="h-4 w-4" />Export Report</Button><Button variant="secondary"><CalendarDays className="h-4 w-4" />01/05/2024 - 31/05/2024<ChevronDown className="h-4 w-4" /></Button></div>
      </div>
...
function ArtifactsLibraryScreen() {
  ...
  return (
    <div>
      ...
      <ImprovementOutcomeCompactWidget surface="artifacts" />
      <LearningRecommendationCompactWidget surface="artifacts" />
      <RecommendationExecutionCompactWidget surface="artifacts" />
      <ImprovementLoopCompactWidget surface="artifacts" />
      <ImprovementLoopGovernanceCompactWidget surface="artifacts" />
      <ImprovementLoopQueueCompactWidget surface="artifacts" />
      <ImprovementLoopWorkerCompactWidget surface="artifacts" />
      <WorkerObservabilityCompactWidget surface="artifacts" />
      <WorkerRecoveryCompactWidget surface="artifacts" />
      <CertifiedSandboxRunCompactWidget surface="artifacts" />
      <E2EActionFlowCompactWidget surface="artifacts" />
