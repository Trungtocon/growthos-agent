...
function TicketSide() {
  ...
  return (
    <div className="space-y-2">
      ...
      <Panel title="Chi phÃ­"><SideRows rows={[['Estimated Cost', estimatedCost], ['Estimated Duration', estimatedDuration], ['Budget status', data.budgetPolicy?.status ?? 'not evaluated']]} /></Panel>
