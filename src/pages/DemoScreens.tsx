...
function TicketSide() {
  ...
  return (
    <div className="space-y-2">
      ...
      <Panel title="Rui ro"><SideRows rows={[["Risk level", workflowStatusLabel(estimatedRisk)], ['Policy checks', `${policyStatus} / ${data.authorization.currentRole.name} / audit ${data.authorization.auditSummary.highRiskEvents}`], ['Pending approvals', `${data.approval?.status === 'pending' ? '1' : '0'} / denied ${data.authorization.deniedActionSummary.totalDenied}`]]} /></Panel>
