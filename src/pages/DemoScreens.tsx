...
function TicketSide() {
  ...
  return (
    <div className="space-y-2">
      ...
      <Panel title="Chi phÃ­"><SideRows rows={[['Est / Actual', `${estimatedCost} / ${actualCost}`], ['Variance', variance], ['Quota status', data.quotaStatus ?? 'ok']]} /></Panel>
