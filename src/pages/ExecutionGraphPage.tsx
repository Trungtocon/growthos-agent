...
export function ExecutionGraphPage() {
  ...
  return (
    <div data-route="/execution-graph" data-execution-graph-route>
      ...
      <WorkerRecoveryCompactWidget surface="execution-graph" />
      <ChaosSimulationCompactWidget surface="execution-graph" />
      <CertifiedSandboxRunCompactWidget surface="execution-graph" />
      <PageHeader
