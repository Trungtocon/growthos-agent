...
export function ExecutionGraphPage() {
  ...
  return (
    <div data-route="/execution-graph" data-execution-graph-route>
      ...
      <EvaluationFeedbackCompactWidget runId={DEMO_RUN_ID} surface="execution-graph" />
      <FeedbackActionPlanCompactWidget runId={DEMO_RUN_ID} surface="execution-graph" />
      <ActionPlanExecutionCompactWidget runId={DEMO_RUN_ID} surface="execution-graph" />
