...
const visibleRoutes = [
  ...
  '/evaluation', '/worker-control', '/worker-recovery', '/chaos', '/runtime-certification', '/certified-sandbox-run', '/production-readiness', '/deployment-config', '/backend-adapter', '/backend-readiness', '/api-contracts', '/e2e-action-flow', '/pre-golive-validation',
];
